...
| Add Tag… | Attach one or more freeform labels (see [Session Tagging](#27-session-tagging)) |
...
## 29. AI Intelligence — Summaries & Entity Extraction
