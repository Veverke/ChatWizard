...
export function buildClassificationPrompt(session: Session): string {
    const intro = [
        ...
        '  - Second-level folders capture a sub-topic within that topic',
        '    (e.g. "Branch Management" under "Git", "UI Polish" under "Features").',
        '',
        ...
        '- Fixing a UI crash → "Bugs|UI"',
        '- Test fixture setup → "Testing|Fixtures"',
        '- Restructuring a module → "Refactoring|Code Restructure"',
        '- Planning a new MCP server → "Features|MCP"',
        ...
        '- Keep SecondLevel more specific than the parent, but still broad enough to group',
        '  multiple related chats (e.g. "UI" under "Features", not "Color Palette Improvement").',
        '- REUSE second-level labels across chats that share the same sub-topic. If you classified',
        '  another chat as "Bugs|UI" earlier, use "Bugs|UI" again for this one if it fits.',
        '- Prefer these reusable second-level labels when applicable:',
        '    Bugs:       UI, Logic, Build, Config, Data, Regression, Crash, Error Handling',
        '    Features:   UI, MCP, Search, Export, API, Dashboard, Settings, Notifications',
        '    Testing:    Fixtures, Unit, E2E, Integration, Mocks, Coverage, CI',
        '    Refactoring: Code Restructure, Cleanup, Migration, Types, Naming',
        '    Architecture: Schema Design, Data Flow, API Design, State, Security',
        '    Best Practices: Coding Conventions, Patterns, Performance, Security, Docs',
        '    Git:        Branch Management, Merge, History, Config, Hooks',
        '    Deployment: Pipeline, Docker, Config, Monitoring, Scripts',
        '    Python:     Debugging, Packaging, Types, Performance, Async',
        '    Vs Code:    Extension, Config, Keybindings, Snippets, Debugger',
        '    API:        Design, Client, Auth, Routes, Middleware',
        '    Database:   Schema, Queries, Migrations, Indexing, Backup',
        '- If none of the above fit, invent a new label — but make it general enough for reuse.',
